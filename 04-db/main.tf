module "db" {
  ...
  #when you delete RDS, it will automatically create .snapshot for safety before delete.
  #snapshot is attached to VPC.you cant delete VPC, because it has dependency resource of snapshot.
