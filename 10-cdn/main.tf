resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              = "web-${var.environment}.${var.zone_name}"#web-dev.learningdevopsaws.online
  ...
  enabled             = true
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.learningdevopsaws.online
